<template>
  <div class="text-white p-5 w-full">
    <h1 class="text-xl font-bold">Learn About <span class="text-green font-bold">IDOR</span> and <span class="text-green font-bold">2FA</span> Vulnerabilities</h1>
    
    <p class="lg:w-2/3 mt-2">
      Watch the video below to learn more about IDOR vulnerabilities and bruteforcing two-factor authentication or session tokens.
    </p>

    <div class="flex flex-row items-center mt-5">
     <iframe class="w-full xl:w-1/2 lg:w-2/3 aspect-[16/9]" src="https://www.youtube-nocookie.com/embed/rloqMGcPMkI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
  </div>
</template>
